...
class main{
	static void Main(){
		...
		*/ 
		...
		printResults(resultCC, resultNoCC, resultV, 2);
		...
		printResults(resultCC, resultNoCC, resultV, -4);
		...
		printResults(resultCC, resultNoCC, resultV, PI);

	}

	public static void printResults(vector resultCC, vector resultNoCC, vector resultV, 
		double resultAnalytical){
			WriteLine("Result with o4ac: \t\t{0:f14}", resultCC[0]); 
			WriteLine("Result with o4a: \t\t{0:f14}", resultNoCC[0]);
			WriteLine("Result with o8av: \t\t{0:f14}", resultV[0]);
