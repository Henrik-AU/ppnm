...
class main{
	static void Main(){
		...
		*/ 
		...
		printResults(result_o4ac, result_o4a, result_o8av, 2, eps, acc);
		...
		printResults(result_o4ac, result_o4a, result_o8av, -4, eps, acc);
		...
		printResults(result_o4ac, result_o4a, result_o8av, PI, eps, acc);
	...
	public static void printResults(vector result_o4ac, vector result_o4a, vector result_o8av, 
		double resultAnalytical, double eps, double acc){
			...
			result_o4ac[0], resultAnalytical-result_o4ac[0]); 
			WriteLine("Result with o4a: \t\t{0:f14} (deviation: {1})",
			result_o4a[0], resultAnalytical-result_o4a[0]); 
